...
import tt.ebey.pageElements.EbayHomePageLocators;
...
public class EbayHomePageActions {
	...
	/*
	 * public void searchShirts() { EbayHomePageLocatorsObj.txtbxSearch.clear();
	 * EbayHomePageLocatorsObj.txtbxSearch.sendKeys("Shirts");
	 * EbayHomePageLocatorsObj.btnSearch.click(); }
	 * 
	 * public void searchShoes(){ EbayHomePageLocatorsObj.txtbxSearch.clear();
	 * EbayHomePageLocatorsObj.txtbxSearch.sendKeys("Shoes");
	 * EbayHomePageLocatorsObj.btnSearch.click(); }
	 * 
	 * public void searchElectronics() {
	 * EbayHomePageLocatorsObj.txtbxSearch.clear();
	 * EbayHomePageLocatorsObj.txtbxSearch.sendKeys("Electronics");
	 * EbayHomePageLocatorsObj.btnSearch.click(); }
	 * 
